...
// TODO
-Don't store results on edges, but externally in a (temporary / reusable) per level store; this reduces memory usage, since edges can remain pointers.

A more substantial performance increase can be gained by caching 'expected children' for every type of node per level; this will ensure linear scaling for non-left-factored grammars and enables further optimization (which we'll get into later on in this section). The reason for this is the following; if we take the grammar: $S\,::=\,E,\,E\,::=\,E\,+\,E\,|\,E\,-\,E\,|\,E\,*\,E\,|\,1$, we would expand it like this:
\begin{enumerate}
 \setlength{\itemsep}{0pt}
 \setlength{\parskip}{0pt}
 \setlength{\parsep}{0pt}
 
 \item $S$(-1) $\rightarrow$ $E$(0)
 \item $E$(0) $\rightarrow$ $E$(1) + $E$(2)
 \item $E$(0) $\rightarrow$ $E$(3) - $E$(4)
 \item $E$(0) $\rightarrow$ $E$(5) * $E$(6)
 \item $E$(0) edges = {$E$(1) + $E$(2), $E$(3) - $E$(4), $E$(5) * $E$(6)}
 \item $E$(1) $\rightarrow$ $E$(1) + $E$(2)
 \item $E$(1) $\rightarrow$ $E$(3) - $E$(4)
 \item $E$(1) $\rightarrow$ $E$(5) * $E$(6)
 \item $E$(1) edges = {$E$(1) + $E$(2), $E$(3) - $E$(4), $E$(5) * $E$(6)}
 \item $E$(3) $\rightarrow$ $E$(1) + $E$(2)
 \item $E$(3) $\rightarrow$ $E$(3) - $E$(4)
 \item $E$(3) $\rightarrow$ $E$(5) * $E$(6)
 \item $E$(3) edges = {$E$(1) + $E$(2), $E$(3) - $E$(4), $E$(5) * $E$(6)}
 \item $E$(5) $\rightarrow$ $E$(1) + $E$(2)
 \item $E$(5) $\rightarrow$ $E$(3) - $E$(4)
 \item $E$(5) $\rightarrow$ $E$(5) * $E$(6)
 \item $E$(5) edges = {$E$(1) + $E$(2), $E$(3) - $E$(4), $E$(5) * $E$(6)}
\end{enumerate}
Clearly demonstrating quardratic behaviour. If we would remember what $E$(0) was expanded to, we can reuse it's list of edges for $E$(1), $E$(3) and $E$(5); making the expand look like this:
\begin{enumerate}
 \setlength{\itemsep}{0pt}
 \setlength{\parskip}{0pt}
 \setlength{\parsep}{0pt}
 ...
 \item $E$(0) $\rightarrow$ $E$(5) * $E$(6)
 \item $E$(0) edges = {$E$(1) + $E$(2), $E$(3) - $E$(4), $E$(5) * $E$(6)}
 \item $E$ expand = $E$(0) edges
 \item $E$(1) $\rightarrow$ $E$ expand
 \item $E$(3) $\rightarrow$ $E$ expand
 \item $E$(5) $\rightarrow$ $E$ expand
\end{enumerate}
Now expanding clearly completes in linear time.



// TODO
-Additionally edges can be shared between different nodes, since often nodes are guaranteed to (either partially or entirely) have the same edges, since they are always 'queued' / 'expected' by the same 'parent(s)'. The number of edges can be reduced to $N\,*\,numberOfProductions$ instead of $N\,*\,(numberOfProductions^{2})$. In absence of a priority system that restricts 'parent' / 'child' relations, the number of edges can even be reduced to $N\,*\,numberOfLHS$'s instead of $N\,*\,numberOfProductions$ (with as positive side effect that the parser for any grammar becomes as fast as it's left-factored counterpart (if implemented properly)).
