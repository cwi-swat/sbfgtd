...
public class AmbiguousEpsilonList extends SGLL{
	...
	public static void main(String[] args){
		...
		System.out.println("S([A+(A([a](a))),A+(A(),A([a](a))),A+(repeat(A()),A([a](a))),A+(A([a](a)),A()),A+(A([a](a)),repeat(A())),A+(A(),A([a](a)),repeat(A())),A+(repeat(A()),A([a](a)),A()),A+(repeat(A()),A([a](a)),repeat(A()))]) <- good");
	}
}
