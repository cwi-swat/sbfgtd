...
public class Ambiguous4 extends SGLL{
	...
	private final static ParseStackNode TERMINAL_b4 = new TerminalParseStackNode("b".toCharArray(), 4);
	private final static ParseStackNode TERMINAL_bb5 = new TerminalParseStackNode("bb".toCharArray(), 5);
