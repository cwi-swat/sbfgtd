...
public class NonLeftFactoredShared extends SGTDBF{
	...
	private final static AbstractStackNode[] Ep_E1E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_1, NONTERMINAL_E3};
	private final static AbstractStackNode[] Ep_E2E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_2, NONTERMINAL_E5};
	private final static AbstractStackNode[] Ep_E3E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_3, NONTERMINAL_E7};
	private final static AbstractStackNode[] Ep_E4E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_4, NONTERMINAL_E9};
	private final static AbstractStackNode[] Ep_E5E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_5, NONTERMINAL_E11};
	private final static AbstractStackNode[] Ep_E6E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_6, NONTERMINAL_E13};
	private final static AbstractStackNode[] Ep_E7E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_7, NONTERMINAL_E15};
	private final static AbstractStackNode[] Ep_E8E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_8, NONTERMINAL_E17};
	private final static AbstractStackNode[] Ep_E9E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_9, NONTERMINAL_E19};
	private final static AbstractStackNode[] Ep_E10E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_10, NONTERMINAL_E21};
	private final static AbstractStackNode[] Ep_E11E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_11, NONTERMINAL_E23};
	private final static AbstractStackNode[] Ep_E12E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_12, NONTERMINAL_E25};
	private final static AbstractStackNode[] Ep_E13E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_13, NONTERMINAL_E27};
	private final static AbstractStackNode[] Ep_E14E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_14, NONTERMINAL_E29};
	private final static AbstractStackNode[] Ep_E15E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_15, NONTERMINAL_E31};
	private final static AbstractStackNode[] Ep_E16E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_16, NONTERMINAL_E33};
	private final static AbstractStackNode[] Ep_E17E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_17, NONTERMINAL_E35};
	private final static AbstractStackNode[] Ep_E18E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_18, NONTERMINAL_E37};
	private final static AbstractStackNode[] Ep_E19E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_19, NONTERMINAL_E39};
	private final static AbstractStackNode[] Ep_E20E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_20, NONTERMINAL_E41};
	private final static AbstractStackNode[] Ep_E21E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_21, NONTERMINAL_E43};
	private final static AbstractStackNode[] Ep_E22E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_22, NONTERMINAL_E45};
	private final static AbstractStackNode[] Ep_E23E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_23, NONTERMINAL_E47};
	private final static AbstractStackNode[] Ep_E24E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_24, NONTERMINAL_E49};
	private final static AbstractStackNode[] Ep_E25E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_25, NONTERMINAL_E51};
	private final static AbstractStackNode[] Ep_E26E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_26, NONTERMINAL_E53};
	private final static AbstractStackNode[] Ep_E27E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_27, NONTERMINAL_E55};
	private final static AbstractStackNode[] Ep_E28E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_28, NONTERMINAL_E57};
	private final static AbstractStackNode[] Ep_E29E = new AbstractStackNode[]{NONTERMINAL_E0, LITERAL_29, NONTERMINAL_E59};
