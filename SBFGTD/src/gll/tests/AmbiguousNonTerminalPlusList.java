...
public class AmbiguousNonTerminalPlusList extends SGLL{
	...
	public AmbiguousNonTerminalPlusList(char[] input){
		super(input);
	}
	...
	public static void main(String[] args){
		AmbiguousNonTerminalPlusList nrpl = new AmbiguousNonTerminalPlusList("aaa".toCharArray());
