...
Other variations are also possible. Like applying a similar restriction to preceding characters or instead of restricting certain characters before or after the production making them required instead. Additionally one could even restrict the production from matching a certain set of strings or regular expressions. There are numereous possibilities.
