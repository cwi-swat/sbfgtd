...
While we focussed on a level synchronized version of our algorithm, it also possible to create a recursive decent variant. It can be tricky to implement, but there is nothing that stands in the way of this possibility.
