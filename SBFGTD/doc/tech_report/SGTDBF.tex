...
To make the comparison as fair as possible, all parsers were purely executed as recognizers, so no trees were build and no filtering was applied. Additionally, we disabled the GSS garbage collector for the C implementation of SGLR, since it was triggering quardatic behaviour.
