...
In the C category Bison dominates. SGLR is over fifteen times slower then Bison on this grammar. As can be seen our parser also outperforms it by quite a significant amount.
