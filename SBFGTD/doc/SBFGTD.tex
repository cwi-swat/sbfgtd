...
First of all, left recursion. Normal top-down parsers can't handle grammar rules containing left recursion. Because we introduce sharing into the GSS we automatically terminalize all these rules. For example, if we take the grammar:\\
$S ::= A$\\
$A ::= Aa | a$\\
