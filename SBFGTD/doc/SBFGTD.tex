...
--Edge levels = one result per level.\\
-Update prefixes.\\
...
Note however that GSS prefix-sharing was enabled while gathering the statistics for this example (see section \ref{sec:prefixSharing}). Without this optimization the number of prefixes and nodes would have been higher.
