...
We compared our performance results with JavaCup, which was used in combination with JFlex. We chose for JavaCup, since it is one of the more widely known and used LALR parsers that is written in Java.
