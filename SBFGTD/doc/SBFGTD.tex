...
We compared our performance results with JavaCup, which was used in combination with JFlex. We chose for JavaCup, since it is one of the best known and widely used LALR parsers that is written in Java.

\begin{figure}[H]
\centering
\includegraphics[scale=0.5]{vsLALR.png}
\caption{A performance comparison with a LALR parser.}
\end{figure}
