...
-Top-down is considered to be too slow in general (usually uses backtracking, which doesn't scale well; additionally non-left-factored grammar don't perform well with this), so it's fairly unpopular.
