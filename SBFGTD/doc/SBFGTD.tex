...
\begin{enumerate}
 ...
 \item If the end of the input has been reached and we have at least one derivation for one of the start symbols we are successful; otherwise parsing failed.
\end{enumerate}
...
In the figure above we see a section of the parse forest. It illustrates how the results of the production $S\,::=\,AAA$ are stored in memory. Also note how nodes with the same start position have the same set of prefixes associated with them, as indicated at the start of this chapter.
